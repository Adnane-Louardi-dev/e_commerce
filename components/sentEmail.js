      ...
      <div className="mx-auto w-64 bg-yellow-500 rounded-lg p-3">
         <div className="mt-4">
            <div className="text-center">
               <input type="email" placeHolder="type your email..." name="email" className="w-56 h-10 px-2 rounded-lg" />
            </div>
            <div className="mt-4 text-center">
               <textarea name="mssg" placeHolder="type your message..." rows="5" className="resize-none w-56 p-2 rounded-lg"></textarea>
            </div>
         </div>
